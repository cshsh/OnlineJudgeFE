  ...
  <el-row type="flex" :gutter="20">
    <el-col :md="10" :lg="8">
      ...
      <panel title="System Overview">
        <p>Judge Server:  <a href="#">{{infoData.judge_server_count}}</a></p>
        <p>HTTPS Status:
          <el-tag :type="https ? 'success' : 'info'" size="small">
            {{ https ? 'Enabled' : 'Disabled'}}
          </el-tag>
        </p>
        <p>Force HTTPS:
          <el-tag :type="forceHttps ? 'success' : 'info'" size="small">
            {{forceHttps ? 'Enabled' : 'Disabled'}}
          </el-tag>
        </p>
        <p>CDN HOST:
          <el-tag :type="cdn ? 'success' : 'info'" size="small">
            {{cdn ? cdn : 'Not Use'}}
          </el-tag>
        </p>
      </panel>
